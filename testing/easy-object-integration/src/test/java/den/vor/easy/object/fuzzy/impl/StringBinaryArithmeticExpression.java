...
public class StringBinaryArithmeticExpression extends IntExpression {

    private IntExpression left;
    private List<Pair<Operator, IntExpression>> right;

    public StringBinaryArithmeticExpression(GenerationContext context, CustomRandom customRandom) {
