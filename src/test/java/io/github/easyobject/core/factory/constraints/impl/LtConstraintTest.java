...
class LtConstraintTest extends ConstraintTestBase {
    ...
    private LtConstraint<ComparableClass> ltConstraint = new LtConstraint<>("constraint");
    ...
    void shouldNotChangeBounds_whenValueIsLessThanOrEqualsMinConstraint() {
        ...
        SequenceConstraintsValues<ComparableClass> result = ltConstraint.apply(constraintsValues, value);
